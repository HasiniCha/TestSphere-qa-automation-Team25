...
public class UserPlantSteps {
    ...
    public void user_is_on_plants_page() {
        ...
        for (int i = 0; i < maxRetries; i++) {
            ...
            System.out.println("⚠️ Plants page not loaded, attempt " + (i + 1) + " of " + maxRetries);
    ...
    public void plant_list_displays_all_plants() {
        ...
        if (initialPlantCount == 0) {
            System.out.println("⚠️ WARNING: No plants found. Tests may need test data setup.");
        }
    ...
    public void count_matches_plants_with_quantity_less_than(int threshold) {
        ...
        System.out.println("  - Actual plants with quantity < " + threshold + ": " + actualLowStockCount);
        System.out.println("  - Dashboard low stock count: " + dashboardLowStockCount);
